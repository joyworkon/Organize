...
export const BACKUP_TABLE_QUERIES: readonly TableQueryConfig[] = [
  ...
  },
  {
    table: "notes",
    columns:
      "id, title, content, reading_item_id, icon, cover_url, cover_position, parent_note_id, full_width, font_family, small_font, page_template, is_pinned, last_edit_by, created_at, updated_at",
    userOwned: true,
    order: ["id"],
  },
  {
