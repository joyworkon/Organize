...
> 基线：2026-08-29，`master` = `7587ab2`（PR #174），迁移到 `055`。
...
- 当前基线是 111 个 Vitest 文件、803 条用例、10 个 pgTAP 文件、96 条数据库断言；合并后数量不得无解释下降，跳过数必须为 0。
...
| P0 | P0-01 生产依赖安全升级 | **下一项** | M | — |
| P0 | P0-02 数据库越权热修 | 待办 | M | P0-01 |
| P0 | P0-03 AI 地址与密钥安全 | 待办 | M | P0-02 |
| P0 | P0-04 备份恢复合同重建 | 待办 | L | P0-03 |
| P1 | P1-01 统一稍后读收集链路 | 待办 | M | P0 门禁 |
| P1 | P1-02 修正工作台与经验复习 | 待办 | M | P0 门禁 |
| P1 | P1-03 任务离线冲突与失败可见 | 待办 | L | P0 门禁 |
| P1 | P1-04 速记生命周期补齐 | 待办 | S | P0-04 |
| P2 | P2-01 严格 CI 与核心 E2E | 待办 | L | P1 门禁 |
| P2 | P2-02 Web 上线前能力 | 待办 | L | P2-01 |
